...
DROP TRIGGER IF EXISTS listing_avionics_authorizations_invalidate_listing_provenance;
DROP TRIGGER IF EXISTS listing_avionics_authorizations_invalidate_install_provenance;
