-- Positive publication fixture. Load schema/sqlite.sql before this file.
...
INSERT INTO aircraft_identity_decisions (
  ...
  (1, 'make', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'family', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'designation', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'generation', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'generation_designation', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'package', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'package_applicability', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'reference_configuration', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'reference_profile', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'engine_model', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21'),
  (1, 'propeller_model', 'approve_new', 'approved', '{}', '{}', 1, 'approved', '2026-07-21');
