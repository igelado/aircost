...
- Role words around a literal product code are descriptions, not part of its model. From Garmin Dual GI 275 AI & HSI use manufacturer Garmin and model GI 275; from Dual Garmin GI275 ADI and HSI with Battery Backup use manufacturer Garmin and model GI275. Treat Dual as quantity ambiguity and AI, ADI, and HSI as roles/capability evidence, never as model suffixes.\n\
